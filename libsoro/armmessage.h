...
namespace ArmMessage  {
    ...
    inline float getGamepadX(const char *message) {
        return GamepadUtil::axisByteToAxisFloat(message[Index_GamepadX]);
    }
    ...
    inline float getGamepadY(const char *message) {
        return GamepadUtil::axisByteToAxisFloat(message[Index_GamepadY]);
    }
    ...
    inline float getGamepadYaw(const char *message) {
        return GamepadUtil::axisByteToAxisFloat(message[Index_GamepadYaw]);
    }
    ...
    inline float getGamepadWrist(const char *message) {
        return GamepadUtil::axisByteToAxisFloat(message[Index_GamepadWrist]);
    }
    ...
    inline unsigned short getMasterYaw(const char *message) {
        return Util::deserialize<unsigned short>(message + Index_MasterYaw);
    }
    ...
    inline unsigned short getMasterShoulder(const char *message) {
        return Util::deserialize<unsigned short>(message + Index_MasterShoulder);
    }
    ...
    inline unsigned short getMasterElbow(const char *message) {
        return Util::deserialize<unsigned short>(message + Index_MasterElbow);
    }
    ...
    inline unsigned short getMasterWrist(const char *message) {
        return Util::deserialize<unsigned short>(message + Index_MasterWrist);
    }
