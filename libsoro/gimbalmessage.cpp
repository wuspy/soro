...
void setGamepadData(char *message, short yawAxis, short pitchAxis, bool leftButton, bool homeButton, bool rightButton, bool armButton) {
    ...
    message[0] = (unsigned char)reinterpret_cast<int&>(messageType);
    message[Index_Yaw] = GamepadUtil::axisShortToAxisByte(GamepadUtil::filterGamepadDeadzone(yawAxis, GAMEPAD_DEADZONE));
    message[Index_Pitch] = GamepadUtil::axisShortToAxisByte(GamepadUtil::filterGamepadDeadzone(pitchAxis, GAMEPAD_DEADZONE));
